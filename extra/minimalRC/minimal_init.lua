...
vim.cmd [[ source $HOME/.config/nvim/vimscript/general/settings.vim ]]
...
vim.cmd [[ luafile $HOME/.config/nvim/lua/mappings/general.lua]]
vim.cmd [[ source $HOME/.config/nvim/vimscript/general/themes.vim ]]
